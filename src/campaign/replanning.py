...
class ReplanningController:
    ...
    async def on_drift(
        ...
        try:
            ...
            self._log_warning("ReplanningController: drain timeout — proceeding to replan request")
    ...
    def state_dict(self) -> dict:
        ...
        return {
            ...
            "last_request_id": (self.last_request.request_id if self.last_request else None),
        }

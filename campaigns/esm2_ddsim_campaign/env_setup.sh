...
#
# Creates a Python 3.10+ venv with campaign_manager and DeepDriveSim.
...
echo ""
echo "── Step 4: campaign_manager[dragon,dev,plotting] ──"
"${PIP}" install -q -e "${CM_DIR}[dragon,dev,plotting]"
...
# ── 7. esm2_ddsim_campaign requirements ─────────────────────────────────────
echo ""

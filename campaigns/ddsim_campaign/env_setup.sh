#!/bin/bash
# =============================================================================
# Dummy DDSim Campaign environment setup — Delta HPC (NCSA)
#
...
#   bash delta_env_setup.sh [--env-dir DIR] [--cm-dir DIR] [--adr-dir DIR] [--python PATH]
#
# Defaults:
#   ENV_DIR = /u/$USER/ve/ddsim_campaign
#   CM_DIR  = $SCRATCH/$USER/campaign_manager
#   ADR_DIR = $SCRATCH/$USER/radical.adr
#   python  = auto-detected (cray-python/3.11.7, anaconda3, python/3.11, python/3.10)
# =============================================================================
...
ENV_DIR="${ENV_DIR:-/u/${USER}/ve/ddsim_campaign}"
...
# ── 3. radical.adr (local — not on PyPI, must come before campaign_manager[adr]) ──
echo ""
echo "── Step 3: radical.adr (local editable) ──"
"${PIP}" install -q -e "${ADR_DIR}"

# ── 4. campaign_manager + ADR extra ──────────────────────────────────────────
echo ""
echo "── Step 4: campaign_manager[adr] (editable) ──"
...
echo "  cd ${CM_DIR}/campaigns/ddsim_campaign"
